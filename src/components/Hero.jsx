    ...
    <div className='bg-hero bg-no-repeat bg-cover min-h-[810px] w-full' style={{ backgroundImage: `url(${herobg})` }}>
      ...
      <div className='container mx-auto flex flex-wrap mt-[120px] max-lg:mt-12 max-lg:gap-5'>
        <div className='w-1/2 max-lg:w-full flex flex-col justify-between'>
          <div>
            <h1 className='!leading-110 text-custom-xl max-lg:text-5xl max-md:text-4xl max-sm:text-3xl font-normal text-white max-w-[612px] max-lg:max-w-full'>Easily Compare <span className='font-bold'> Energy, Gas, and Internet </span> Plans</h1>
          ...
          <div>
            <p className='!leading-110 max-lg:text-3xl max-md:text-2xl max-sm:text-xl text-custom-lg max-w-[548px] text-green-vogue max-lg:text-white max-lg:max-w-full'>More than <span className='font-bold text-sky-blue'> 80,000+ </span> companies trust bill central </p>
          </div>
        </div>
