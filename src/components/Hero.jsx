      ...
      <div className='container mx-auto flex flex-wrap mt-[120px] max-lg:mt-12 max-lg:gap-5'>
        <div className='w-1/2 max-lg:w-full flex flex-col justify-between'>
          <div>
            ...
            <p className='text-white max-w-[506px] !leading-custom-xl max-lg:max-w-full mt-4 max-md:text-sm'>Find and switch to the best energy, gas, and internet plans with ease. Our platform simplifies your search, letting you compare providers and make informed decisions, all in one place.</p>
          ...
          <div>
              <p className='!leading-custom-lg max-lg:text-3xl max-md:text-2xl max-sm:text-xl text-custom-4xl max-w-[548px] text-green-vogue max-lg:text-white max-lg:max-w-full'>More than <span className='font-bold text-ball-blue'> 80,000+ </span> companies trust bill central </p>
            </div>
        </div>
